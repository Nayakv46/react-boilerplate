  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          "size-(--cell-size) p-0 transition-all duration-200",
        ...
        caption_label: cn(
          "font-medium select-none", //"transition-all duration-200",
          captionLayout === "label"
        ...
        week: cn(
          "mt-2 flex w-full", // 'animate-in fade-in-0 duration-200'",
        ...
        day: cn(
          "group/day relative aspect-square h-full w-full rounded-(--cell-radius) p-0 text-center select-none transition-all duration-150",
        ...
        Chevron: ({ className, orientation, ...props }) => {
          if (orientation === "left") {
            return (
              <ChevronLeftIcon
                className={cn(
                  "cn-rtl-flip size-4 transition-transform duration-200",
                  className,
                )}
                {...props}
              />
